...
void zfp_field_set_size_1d(zfp_field *field, uint n)
{
  field->nx = n;
  field->ny = 0;
  field->nz = 0;
...
zfp_field_set_metadata(zfp_field *field, uint64 meta)
{
  ...
  case 1:
    ...
    field->nx = (meta & UINT64C(0x0000ffffffff)) + 1;
    meta >>= 48;
    field->ny = 0;
    field->nz = 0;
    field->nw = 0;
    break;
  case 2:
    field->nx = (meta & UINT64C(0xffffff)) + 1;
    meta >>= 24;
    field->ny = (meta & UINT64C(0xffffff)) + 1;
    meta >>= 24;
    field->nz = 0;
    field->nw = 0;
    break;
  case 3:
    field->nx = (meta & UINT64C(0xffff)) + 1;
    meta >>= 16;
    field->ny = (meta & UINT64C(0xffff)) + 1;
    meta >>= 16;
    field->nz = (meta & UINT64C(0xffff)) + 1;
    meta >>= 16;
    field->nw = 0;
    break;
  case 4:
    field->nx = (meta & UINT64C(0xfff)) + 1;
    meta >>= 12;
    field->ny = (meta & UINT64C(0xfff)) + 1;
    meta >>= 12;
    field->nz = (meta & UINT64C(0xfff)) + 1;
    meta >>= 12;
    field->nw = (meta & UINT64C(0xfff)) + 1;
    meta >>= 12;
    break;
  }
  field->sx = field->sy = field->sz = field->sw = 0;
...
{
  return bitstream_size(zfp->stream);
}
