...
extern "C" {
    ...
    extern void viewport_moment_map_1_rect(struct fixed_block_t * compressed, int32_t width, int32_t height, float pmin, float pmax, float * view_I, float * view_Iv, bool * view_mask, int32_t stride, int32_t x1, int32_t x2, int32_t y1, int32_t y2, int32_t horizontal, int32_t vertical, double velocity);
    extern void viewport_moment_map_2_rect(struct fixed_block_t * compressed, int32_t width, int32_t height, float pmin, float pmax, float * view_I, float * view_Iv, float * view_Iv2, bool * view_mask, int32_t stride, int32_t x1, int32_t x2, int32_t y1, int32_t y2, int32_t horizontal, int32_t vertical, double velocity);
    extern void viewport_moment_map_8_rect(struct fixed_block_t * compressed, int32_t width, int32_t height, float pmin, float pmax, float * view_I, bool * view_mask, int32_t stride, int32_t x1, int32_t x2, int32_t y1, int32_t y2, int32_t horizontal, int32_t vertical, double velocity);
