...
extern "C" {
    ...
    extern int32_t polarisation_simd_3(float * pixels, uint8_t * mask, int32_t plane_offset, int32_t stride, int32_t range, int32_t i, int32_t j, int32_t xmax, int32_t ymax);
