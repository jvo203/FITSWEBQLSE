                                          ...
                                          void **ptr)
{
    ...
    if (strstr(url, "/statistics/") != NULL)
    {
        ...
        mjson_printf(mjson_print_dynamic_buf, &json, "{%Q:[%.*g,%.*g,%.*g,%.*g],%Q:%ld,%Q:%.*g,%Q:%ld}", "sumP", 12, sumP[0], 12, sumP[1], 12, sumP[2], 12, sumP[3], "countP", countP, "sumN", 12, sumN, "countN", countN);
