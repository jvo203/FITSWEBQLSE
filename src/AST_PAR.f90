...
!  Double precision NaN flag (this value is not actually a NaN itself).
      ...
      PARAMETER ( AST__NAN = -1.70780847811919983D+308 )
...
!      PARAMETER ( AST__UKERNN = 2 )
      ...
      INTEGER(kind=8) AST_RESAMPLE8B
      INTEGER(kind=8) AST_RESAMPLE8D
      INTEGER(kind=8) AST_RESAMPLE8I
      INTEGER(kind=8) AST_RESAMPLE8K
      INTEGER(kind=8) AST_RESAMPLE8R
      INTEGER(kind=8) AST_RESAMPLE8S
      INTEGER(kind=8) AST_RESAMPLE8UB
      INTEGER(kind=8) AST_RESAMPLE8UI
      INTEGER(kind=8) AST_RESAMPLE8UK
      INTEGER(kind=8) AST_RESAMPLE8US
      INTEGER(kind=8) AST_RESAMPLE8UW
      INTEGER(kind=8) AST_RESAMPLE8W
...
!  Region class.
      ...
      INTEGER AST_MASKUW
      INTEGER AST_MASKW
      INTEGER(kind=8) AST_MASK8B
      INTEGER(kind=8) AST_MASK8D
      INTEGER(kind=8) AST_MASK8I
      INTEGER(kind=8) AST_MASK8R
      INTEGER(kind=8) AST_MASK8S
      INTEGER(kind=8) AST_MASK8UB
      INTEGER(kind=8) AST_MASK8UI
      INTEGER(kind=8) AST_MASK8US
      INTEGER(kind=8) AST_MASK8UW
      INTEGER(kind=8) AST_MASK8W
