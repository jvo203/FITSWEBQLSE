...
LIBS = -L/usr/local/lib `pkg-config --libs glib-2.0` `pkg-config --libs libcpuid` `pkg-config --libs libmicrohttpd` `pkg-config --libs liblz4` -L/usr/local/lib64 -lcfitsio -lsqlite3 -lcurl -lz -pthread -lzmq `pkg-config --libs libczmq` `pkg-config --libs x265`
# -lzfp before cfitsio
