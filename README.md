...
# FITSWEBQLSE STATUS
The first _stable_ **BETA** milestone has been reached. It works natively on **Apple Silicon**. The attention has turned towards debugging and adding support for extra higher moments.
