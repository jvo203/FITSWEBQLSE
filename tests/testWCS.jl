...
physical = [856.49056, 438.4528, 136, 0] # 0-indexed (but ds9 seems to use 1-indexed)
fk5 = [261.2105354, -34.2435452, 9.317640936376723e10, 0.0] # 0-indexed (but ds9 seems to use 1-indexed)
