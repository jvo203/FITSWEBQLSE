...
# 8. libmicrohttpd
    ...
    # The experimental WebSocket extension is provided by version 1.0.2.
    wget https://ftpmirror.gnu.org/libmicrohttpd/libmicrohttpd-1.0.2.tar.gz
    tar zxvf libmicrohttpd-1.0.2.tar.gz
