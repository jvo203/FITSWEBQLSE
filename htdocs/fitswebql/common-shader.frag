...
vec4 colormap_wolfram(float x, float alpha) {
    if( x < 0.0) {
        return vec4(0.0, 0.0, 0.0, 0.0);
    }

    if( x < 0.166667) {
        vec4 x1 = vec4(0.2588235294117647, 0.3568627450980392, 0.8901960784313725, alpha);
        vec4 x2 = vec4(0.2313725490196078, 0.4980392156862745, 0.8470588235294118, alpha);
        float a = (x - 0.0) / 0.166667;
        return mix(x1, x2, a);
    }

    if( x < 0.333333) {
        vec4 x1 = vec4(0.2313725490196078, 0.4980392156862745, 0.8470588235294118, alpha);
        vec4 x2 = vec4(0.39215686274509803, 0.6588235294117647, 0.796078431372549, alpha);
        float a = (x - 0.166667) / (0.333333 - 0.166667);
        return mix(x1, x2, a);
    }

    if( x < 0.5) {
        vec4 x1 = vec4(0.39215686274509803, 0.6588235294117647, 0.796078431372549, alpha);
        vec4 x2 = vec4(0.9647058823529412, 0.9803921568627451, 0.9882352941176471, alpha);
        float a = (x - 0.333333) / (0.5 - 0.333333);
        return mix(x1, x2, a);
    }
    ...
    if( x < 0.666667) {
        vec4 x1 = vec4(0.9568627450980393, 0.9568627450980393, 0.8980392156862745, alpha);
        vec4 x2 = vec4(0.9137254901960784, 0.792156862745098, 0.4627450980392157, alpha);
        float a = (x - 0.5) / (0.666667 - 0.5);
        return mix(x1, x2, a);
    }

    if( x < 0.833333) {
        vec4 x1 = vec4(0.9137254901960784, 0.792156862745098, 0.4627450980392157, alpha);
        vec4 x2 = vec4(0.8588235294117647, 0.5607843137254902, 0.00784313725490196, alpha);
        float a = (x - 0.666667) / (0.833333 - 0.666667);
        return mix(x1, x2, a);
    }

    if( x <= 1.0) {
        vec4 x1 = vec4(0.8588235294117647, 0.5607843137254902, 0.00784313725490196, alpha);
        vec4 x2 = vec4(1.0, 0.4196078431372549, 0.0, alpha);
        float a = (x - 0.833333) / (1.0 - 0.833333);
        return mix(x1, x2, a);
    }
