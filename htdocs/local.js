	...
	for (let i = 0; i < filelist.length; i++) {
		if (filelist[i].type == "file") {
			...
			$("#tbody").append($("<tr></tr>")
				...
				.html("<td><p href=\"" + url + "\"><span class=\"glyphicon glyphicon-open-file\"></span>&nbsp;&nbsp;" + filelist[i].name + "</p></td><td>" + numeral(filelist[i].size).format('0.0 bd') + "</td><td>" + filelist[i].last_modified + "</td>"));
		}
	}
